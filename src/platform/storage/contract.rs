//! Current Graph 7 immutable-store contract facts.
...
pub const ARTIFACT_MANIFEST_DIGEST_DOMAIN: &str = "lkjscript.artifact-manifest.v12";
...
pub const PACKAGE_INTERFACE_OWNER_DIGEST_DOMAIN: &str = "lkjscript.package-interface-owner.v5";
