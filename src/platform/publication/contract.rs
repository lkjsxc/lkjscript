...
pub const REVISION_CONTRACT_IDENTITY: &str = "lkjscript-revision-5";
pub const REVISION_CONTRACT_VERSION: u16 = 5;
...
pub const REVISION_MAGIC: [u8; 8] = *b"LKJREV05";
...
pub const HEAD_MAGIC: [u8; 8] = *b"LKJHEAD5";

pub const REVISION_ENVELOPE_DOMAIN: &str = "lkjscript.revision-record-envelope.v5";
...
pub const HEAD_ENVELOPE_DOMAIN: &str = "lkjscript.head-envelope.v5";
pub const REVISION_IDENTITY_DIGEST_DOMAIN: &str = "lkjscript.semantic-revision.v5";
