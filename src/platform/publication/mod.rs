//! Private Graph 7 accepted-history binding and publication protocol.

#![allow(
    unused_imports,
    reason = "private publication exports become repository consumers at the Graph 7 cutover"
)]
