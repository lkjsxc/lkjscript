//! Declaration-sized compiler units for normalized Graph 6 authority.
//!
...
#![allow(
    unused_imports,
    reason = "private compiler exports become artifact and runtime consumers at the Graph 6 cutover"
)]
