//! Shared Graph 9 compiler, linker, artifact-loader, and dense-runtime preparation.
...
mod tests {
    ...
    fn maintained_application_clean_build_matches_its_owned_artifact() {
        ...
        let repository = GraphRepository::open(&root).expect("open maintained Graph 9 lkjournal");
