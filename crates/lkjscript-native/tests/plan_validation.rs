...
use lkjscript_native::{
    ...
    HeapOperation, InternalMachineArgument, InternalMachineResult, MachinePlanBuilder, NativeError,
    PlanError, ReferenceType, RuntimeCallSlot, Signature, SourceFunctionId, StoreClass, ValueType,
    VerificationError,
};
