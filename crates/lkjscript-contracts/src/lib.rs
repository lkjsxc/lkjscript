...
pub use domains::{
    ...
    LANGUAGE_DIGEST, METRICS, METRICS_DIGEST, MODULE_INTERFACE, NATIVE_IMAGE_CACHE,
    NATIVE_IMAGE_CACHE_DIGEST, NATIVE_LAYOUT, NATIVE_LAYOUT_DIGEST, PACKAGE_LOCK, PACKAGE_MANIFEST,
    ...
    SEMANTIC_SOURCE, SEMANTIC_SOURCE_DIGEST, SOURCE, SOURCE_DIGEST, TYPED_HIR, VERIFIED_SSA,
    VERIFIED_SSA_DIGEST,
};
