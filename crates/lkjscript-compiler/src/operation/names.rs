...
impl Operation {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::F64FromI64Exact => "f64-from-i64-exact",
            Self::F64FromI64Rounded => "f64-from-i64-rounded",
            Self::I64FromF64Exact => "i64-from-f64-exact",
            Self::I64FromF64Trunc => "i64-from-f64-trunc",
            Self::Less => "lt",
            Self::LessEqual => "lte",
            Self::Greater => "gt",
            ...
            Self::PathFromStr => "path-from-str",
            Self::PathFromBuf => "path-from-buf",
            Self::PathToBuf => "path-to-buf",
            Self::PathToStr => "path-to-str",
