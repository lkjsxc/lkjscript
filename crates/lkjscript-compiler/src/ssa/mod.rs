...
use lkjscript_ir::{
    ...
    InstructionMetadata, LoanId as SsaLoanId, MemoryWitnessBinding, MemoryWitnessGroupId,
    MemoryWitnessId, MemoryWitnessParameter, Origin, PlaceId as SsaPlaceId, PlaceMetadata,
