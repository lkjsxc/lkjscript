...
pub(in crate::ssa) fn runtime_operation(operation: Operation) -> Result<RuntimeOp> {
    Ok(match operation {
        ...
        Operation::ByteVectorNew => RuntimeOp::ByteVectorNew,
        Operation::ByteSliceLength => RuntimeOp::ByteSliceLength,
        Operation::ByteSliceByteAt => RuntimeOp::ByteSliceByteAt,
        Operation::ByteSliceMutSetByte => RuntimeOp::ByteSliceMutSetByte,
        Operation::BytesLength => RuntimeOp::BytesLength,
        Operation::BytesByteAt => RuntimeOp::BytesByteAt,
        Operation::CopyBytesSlice => RuntimeOp::CopyBytesSlice,
        ...
        Operation::ConvertStringToBytes => RuntimeOp::ConvertStringToBytes,
        Operation::ConvertBytesToString => RuntimeOp::ConvertBytesToString,
        Operation::PathFromStr => RuntimeOp::PathFromStr,
        Operation::PathFromBytes => RuntimeOp::PathFromBytes,
        Operation::PathToBytes => RuntimeOp::PathToBytes,
        Operation::PathToStr => RuntimeOp::PathToStr,
