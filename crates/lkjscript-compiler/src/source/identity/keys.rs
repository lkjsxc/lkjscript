use crate::source::{
    format, DeclarationKind, SourceNode, SyntaxKind, SEMANTIC_SOURCE_FOUNDATION_SCHEMA,
    SEMANTIC_SOURCE_FOUNDATION_SCHEMA_VERSION, SOURCE_EDITION,
};
...
pub(crate) fn declaration_key_human_identity(
    ...
    format!(
        ...
        SEMANTIC_SOURCE_FOUNDATION_SCHEMA_VERSION,
        SOURCE_EDITION,
        super::escape_compact("edition1-root"),
