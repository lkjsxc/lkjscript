...
pub use workspace::{
    ...
    EntityId, EntityKind, EntityPage, EntityTypeFacts, EnumFieldDraft, EnumTypeParameterDraft,
    ...
    MatchArmDraft, MatchArmView, MatchPatternFieldView, MatchPatternKindView, MatchPatternLabel,
