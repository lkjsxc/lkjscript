...
pub(in crate::codegen) fn runtime_opcode(operation: RuntimeOp) -> Op {
    match operation {
        ...
        RuntimeOp::ByteVectorNew => Op::ByteVectorNew,
        RuntimeOp::ByteSliceLength => Op::ByteSliceLen,
        RuntimeOp::ByteSliceByteAt => Op::ByteSliceRef,
        RuntimeOp::ByteSliceMutSetByte => Op::ByteSliceMutSet,
        RuntimeOp::BytesLength => Op::BytesLength,
        RuntimeOp::BytesByteAt => Op::BytesByteAt,
        RuntimeOp::CopyBytesSlice => Op::CopyBytesSlice,
        ...
        RuntimeOp::ConvertStringToBytes => Op::ConvertStringToBytes,
        RuntimeOp::ConvertBytesToString => Op::ConvertBytesToString,
        RuntimeOp::PathFromStr => Op::PathFromStr,
        RuntimeOp::PathFromBytes => Op::PathFromBytes,
        RuntimeOp::PathToBytes => Op::PathToBytes,
