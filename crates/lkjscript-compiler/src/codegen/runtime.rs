...
pub(in crate::codegen) fn runtime_opcode(operation: RuntimeOp) -> Op {
    match operation {
        ...
        RuntimeOp::OwnedBufNew => Op::ByteVectorNew,
        RuntimeOp::OwnedBufLen => Op::ByteSliceLen,
        RuntimeOp::OwnedBufRef => Op::ByteSliceRef,
        RuntimeOp::OwnedBufSet => Op::ByteSliceMutSet,
