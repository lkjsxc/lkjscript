...
pub(super) fn runtime_symbol(slot: RuntimeCallSlot) -> usize {
    match slot {
        RuntimeCallSlot::IdentityI64 => runtime_identity_i64 as *const () as usize,
        RuntimeCallSlot::Poll => runtime_poll as *const () as usize,
        RuntimeCallSlot::EnterFunction => runtime_enter_function as *const () as usize,
        RuntimeCallSlot::CollectReference => runtime_collect_reference as *const () as usize,
        RuntimeCallSlot::HeapDispatch => runtime_heap_dispatch as *const () as usize,
        RuntimeCallSlot::ReserveFrame => runtime_reserve_frame as *const () as usize,
        RuntimeCallSlot::RegisterFrame => runtime_register_frame as *const () as usize,
        RuntimeCallSlot::PublishSafepoint => runtime_publish_safepoint as *const () as usize,
        RuntimeCallSlot::UnregisterFrame => runtime_unregister_frame as *const () as usize,
    }
}
