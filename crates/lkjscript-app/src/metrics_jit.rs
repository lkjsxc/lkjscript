...
pub fn render(stats: &JitStats) -> String {
        ...
        .map(|object| {
            ...
            format!(
                concat!(
                    ...
                    "\"installation_ns\":{},\"work_units\":{},\"cache_status\":{},",
                    "\"cache_lookup_ns\":{},\"cache_publication_ns\":{},",
                ...
                string(&format!("{:?}", object.compile_stats.cache_status())),
                object.compile_stats.cache_lookup().as_nanos(),
                object.compile_stats.cache_publication().as_nanos(),
    ...
    format!(
        concat!(
            ...
            "\"cache_corruptions\":{},\"cache_bytes_read\":{},\"cache_bytes_written\":{},",
            "\"cache_publications\":{},\"cache_publication_skips\":{},",
            "\"cache_lookup_ns\":{},\"cache_publication_ns\":{},",
            "\"functions\":[{}],\"objects\":[{}]}}"
        ),
        ...
        stats.cache_bytes_read,
        stats.cache_bytes_written,
        stats.cache_publications,
        stats.cache_publication_skips,
        stats.cache_lookup_time.as_nanos(),
        stats.cache_publication_time.as_nanos(),
        functions,
        objects,
    )
}
