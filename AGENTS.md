...
11. [Equality](docs/decisions/semantics/equality-families.md)
12. [Products](docs/decisions/semantics/immutable-nominal-products.md)
13. [Compiler pipeline](docs/decisions/execution/compiler-pipeline.md)
14. [Ownership](docs/decisions/semantics/ownership-and-borrowing.md)
15. [Traits](docs/decisions/semantics/traits-and-static-dispatch.md)
16. [Native roots](docs/decisions/jit/native-references-and-gc-stack-maps.md)
17. [Runtime JIT](docs/decisions/jit/runtime-jit-instead-of-offline-pgo.md)
18. [Callable baseline JIT](docs/decisions/jit/callable-baseline-jit.md)
19. [Allocation JIT](docs/decisions/jit/allocation-capable-baseline-jit.md)
20. [Proof JIT](docs/decisions/jit/proof-based-optimizing-jit.md)
21. [Repository graph](docs/decisions/platform/repository-intelligence-graph.md)
22. [Agent state](docs/decisions/platform/agent-work-state.md)
23. [Verification](docs/operations/verification.md)
24. [Vision and evidence](docs/vision/README.md)
