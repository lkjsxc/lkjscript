...
- Bounded terminal operations and monotonic stale-safe handles have landed.
  Truthful Results and numeric conformance remain foundation priorities; do not
  build a daemon or JIT on top of those defects.
