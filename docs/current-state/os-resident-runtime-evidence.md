...
slice named here. Application persistence, capability-bearing cells, database
...
- Capability-bearing execution, process cells, tenant attachment, session
  brokers, native windows, graphics, accessibility, and GUI execution remain
  absent.
