...
curl --fail --location --output /tmp/lkjscript-release-check/exact/archive.tar.gz \
  https://github.com/lkjsxc/lkjscript/releases/download/v0.1.3/lkjscript-x86_64-unknown-linux-gnu.tar.gz
curl --fail --location --output /tmp/lkjscript-release-check/exact/SHA256SUMS \
  https://github.com/lkjsxc/lkjscript/releases/download/v0.1.3/SHA256SUMS
...
gh release verify v0.1.3 --repo lkjsxc/lkjscript
gh release verify-asset v0.1.3 /tmp/lkjscript-release-check/exact/archive.tar.gz \
