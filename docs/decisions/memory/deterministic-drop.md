...
**Accepted contract; Current promotion requires executable whole-place cleanup
for byte owners and every typed resource.** Aggregate partial moves remain out
of scope.
