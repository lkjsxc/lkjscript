...
admission. Source `d104edc7` passes all 20 fresh source gates and reached remote main
unchanged. Candidate [35827065894/1](https://github.com/lkjsxc/lkjscript/actions/runs/35827065894)
passes source verification and asset construction, then fails final-target
acceptance on stale standard-test counts in the verifier. That failed producer is
preserved. All four affected fixture expectations are corrected, and fresh complete
HTTP/offline workflows pass against its retained product. Corrected source
`9ea93419` passes all 20 fresh source gates and reached remote main unchanged;
new candidate [35833374673/1](https://github.com/lkjsxc/lkjscript/actions/runs/35833374673)
is running at that exact source. Publication remains authorized but requires
accepted assets.
Preserve old exact dependencies
when their behavior and generated bytes remain valid. The copied native ranking
