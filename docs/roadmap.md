...
acceptance on stale standard-test counts in the verifier. Preserve that failed
producer and correct all affected fixture expectations before renewed source and
candidate acceptance. Publication remains authorized but requires accepted assets.
