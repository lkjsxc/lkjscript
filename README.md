...
The product name may change later; source extension is `.lkjsxc`.

## Product Shape

- Source uses tags without attributes; AI authors most `.lkjsxc` files.
...
```sh
cargo run -p lkjscript2026-app -- run examples/hello/main.lkjsxc
cargo run -p lkjscript2026-app -- run examples/mandel/main.lkjsxc
cargo run -p lkjscript2026-app -- run examples/texteditor/main.lkjsxc path/to/file
cargo run -p lkjscript2026-app -- run examples/http/hello.lkjsxc
